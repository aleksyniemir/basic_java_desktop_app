...
class CarDatabase {
    ...
    public void rentCar(int index, String userEmail)
    {
        changeAvailability(index, "NotAvailable", userEmail);
    }
    public void returnCar(int index)
    {
        changeAvailability(index, "Available", "None");
    }
    private void changeAvailability(int index, String changeTo, String renter)
    {
